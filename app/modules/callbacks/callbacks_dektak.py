...
def callbacks_dektak(app):
    ...
    @app.callback([Output('dektak_database_path_store', 'data'),
    ...
    def load_database_path(folderpath, n_clicks):
        ...
        if database_path is None and n_clicks > 0:
            ...
            return database_path, "Batch fitting has started in a separate python instance", None

        elif database_path is None:
            return database_path, 'Database not found, press "Fit!" to launch batch fitting', None
    ...
    def update_heatmap(selected_plot, database_path, z_min, z_max, edit_toggle):
        ...
        try:
            ...
            heatmap = heatmap_plot(database, mode=selected_plot, title=database_path.name.strip('_database.csv'),
